    ...
    function textChing(){
        document.getElementById('p').innerHTML = 'this is a new javascript learnar'
}


    function fontBig(){
         document.getElementById('font_s').style.fontSize = '40px';
}
  ...
  function myName(){
    document.getElementById('onc').innerHTML='Ab Siddik';
  }
